...
IQTHONPC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/9446ca7b48e18c10690c2.jpg"
...
async def iq(iqthonevent):
    ...
    start = datetime.now()
    iqevent = await edit_or_reply(iqthonevent, "**𓅓︙ جاري فحص السورس **")
    end = datetime.now()
    ms = (end - start).microseconds / 1000
    _, check_sgnirts = check_data_base_heal_th()
    EMOJI = gvarstatus("ALIVE_EMOJI") or "𓅓︙"
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "𝗐𝖾𝗅𝖼𝗈𝗆𝖾 𝗍𝖾𝗅𝖾𝗍𝗁𝗈𝗇 coi"
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/9446ca7b48e18c10690c2.jpg"
...
‌‎⿻┊‌‎PinG 𖠄 {ping} ٫
‌‎⿻┊‌‎VeRsIoN 𖠄 (7.7) ,
‌‎⿻┊‌‎TeLeThoN CoI 𖠄 @Yosr3456"""

@iqthon.on(admin_cmd(pattern="رابط التنصيب(?: |$)(.*)"))    
async def source(e):
    await edit_or_reply(e, "https://github.com",)
...
async def _(event):
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(URL) as request:
            ...
            catevent = await edit_or_reply(event, "**𓅓︙  جـاري إحضـار معلومـات حساب كيثاب ↯**")
            ...
            if sec_res.status_code == 200:
                ...
                for repo in sec_res.json():
                    ...
                    if limit == 0:
                        break
            REPLY = "**𓅓︙  معلومـات الكيثاب لـ :** `{username}`\
                \n**𓅓︙  الإسـم 👤:** [{name}]({html_url})\
                \n**𓅓︙  النـوع 🔧:** `{type}`\
                \n**𓅓︙  الشرڪـة 🏢:** `{company}`\
                \n**𓅓︙  المدونـة 🔭:**  {blog}\
                \n**𓅓︙  الموقـع 📍:**  `{location}`\
                \n**𓅓︙  النبـذة 📝:**  `{bio}`\
                \n**𓅓︙  عـدد المتابعيـن ❤️:**  `{followers}`\
                \n**𓅓︙  الذيـن يتابعهـم 👁:**  `{following}`\
                \n**𓅓︙   عدد ريبو العام 📊:**  `{public_repos}`\
                \n**𓅓︙  الجمهـور 📄:**  `{public_gists}`\
                \n**𓅓︙  تم إنشـاء الملـف الشخصـي ✓** 🔗: `{created_at}`\
                \n**𓅓︙  تم تحديـث الملـف الشخصـي ✓** ✏️: `{updated_at}`".format(
                username=username, **result            )
            if repos:
                REPLY += "\n**𓅓︙  بعـض الريبوات 🔍 :** : " + " | ".join(repos)
...
async def _(event):
    ...
    OUTPUT = f"**𓅓︙  تنبيـه، لقـد تم حـذف جميـع المجلـدات والملفـات الموجـودة في البـوت بنجـاح ✓**"
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ تـليثون سوي - Telethon-Coi ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"𓅓︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس تليثون @Yosr3456 :**\n\n{o}")
            ...
            while flag:
                try:
                    ...
                    if check > 5:
                        break
            if BOTLOG:
                await iqthon.send_message(                    BOTLOG_CHATID,                    f"**𓅓︙   تحـميل المـلف 🗂️  : `{os.path.basename(downloaded_file_name)}`  تـم بنجـاح ✔️**",                )

    iqthon.loop.create_task(install())
@iqthon.on(admin_cmd(pattern=f"{UPDATE}(?: |$)(.*)"))    
async def _(event):
    sandy = await edit_or_reply(event ,                                 "telethon coi::%10 ▰▱▱▱▱▱▱▱▱▱ " ,)
    await asyncio.sleep(1)
    await edit_or_reply(event , "telethon coi::%20 ▰▰▱▱▱▱▱▱▱▱ ")
    await asyncio.sleep(1)
    await edit_or_reply(event , "telethon coi::%30 ▰▰▰▱▱▱▱▱▱▱ ")
    await asyncio.sleep(1)
    await edit_or_reply(event , "telethon coi::%40 ▰▰▰▰▱▱▱▱▱▱ ")
    await asyncio.sleep(1)
    await edit_or_reply(event , "telethon coi::%50 ▰▰▰▰▰▱▱▱▱▱ ")
    await asyncio.sleep(1)
    await edit_or_reply(event , "telethon coi::%60 ▰▰▰▰▰▰▱▱▱▱ ")
    await asyncio.sleep(1)
    await edit_or_reply(event , "telethon coi::%70 ▰▰▰▰▰▰▰▱▱▱ ")
    await asyncio.sleep(1)
    await edit_or_reply(event , "telethon coi::%80 ▰▰▰▰▰▰▰▰▱▱ ") 
    await asyncio.sleep(1)
    await edit_or_reply(event , "telethon coi::%90 ▰▰▰▰▰▰▰▰▰▱ ") 
    await asyncio.sleep(1)
    await edit_or_reply(event , "telethon coi::%100 ▰▰▰▰▰▰▰▰▰▰ ") 
    await asyncio.sleep(1)
    await edit_or_reply(event , """𓅓︙ جـاري تـحديث تليثـون سوي (1.0)
⌚ انتضر من 1 الى 5 دقائق""")
    try:
...
https://t.me/Yosr3456/36
  • لتغير صوره او فيديو امر الفحص اضغط هنا ↶
https://t.me/Yosr3456/39
  • لتغير كليشة امر حماية الخاص اضغط هنا ↶
https://t.me/Yosr3456/35
  • لوضع صوره او فيديو حماية الخاص اضغط هنا ↶
https://t.me/Yosr3456/38
  • لتغير عدد تحذيرات حماية الخاص اضغط هنا ↶
https://t.me/Yosr3456/45
  • لتغير نبذه الوقتيه اضغط هنا ↶
https://t.me/Yosr3456/54
  • لتغير صوره وقتيه اضغط هنا ↶
 https://t.me/Yosr3456/46 
  • لتغير خط زخرفه اسم وقتي اضغط هنا ↶
 https://t.me/Yosr3456/59
  •  لوضع ايموجي بجانب اسم وقتي اضغط هنا ↶
 https://t.me/Yosr3456/37
• لتغير امر من الاوامر اضغط هنا ↶
https://t.me/Yosr3456/4718
• لكيفيه حذف الفار اضغط هنا ↶
https://t.me/Yosr3456/51

قناة الكلايش  : @FGFFG
قناه شروحات الاوامر  : @Yosr3456
قناه المتغيرات او الفارات : @Yosr3456""")
@iqthon.on(admin_cmd(pattern="اطفاء مؤقت( [0-9]+)?$"))    
async def _(event):
    if " " not in event.pattern_match.group(1):
        return await edit_or_reply(event, "𓅓︙  بنـاء الجمـلة ⎀ : `.اطفاء مؤقت + الوقت`")
    counter = int(event.pattern_match.group(1))
    if BOTLOG:
        await event.client.send_message(            BOTLOG_CHATID,            "**𓅓︙   تـم وضـع البـوت في وضـع السڪون لـ : ** " + str(counter) + " **𓅓︙  عـدد الثوانـي ⏱**",        )
    event = await edit_or_reply(event, f"`𓅓︙   حسنـاً، سأدخـل وضـع السڪون لـ : {counter} ** عـدد الثوانـي ⏱** ")
    sleep(counter)
    await event.edit("** 𓅓︙  حسنـاً، أنـا نشـط الآن ᯤ **")
...
async def bad(event):
    ...
    if not vname:
        return await edit_delete(event, f"**𓅓︙   📑 يجب وضع اسم الفار الصحيح من هذه القائمه :\n\n**{vnlist}", time=60)
    vinfo = None
    if " " in vname:
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**𓅓︙  📑 يرجى متابع قناه الفارات تجدها هنا : @iqthon")
            if not vinfo and vname == "PING_IQ":
                return await edit_delete(event, f"**𓅓︙ قم بكتابة الامـر بـشكل صحـيح  :  .اضف فار PING_TEXT النص الخاص بك**")
            if not vinfo:
                return await edit_delete(event, f"**𓅓︙ يـجب وضع القـيمـة الصحـيحه**")
            check = vinfo.split(" ")
            for i in check:
                if (("PIC" in vname) or ("pic" in vname)) and not url(i):
                    return await edit_delete(event, "**𓅓︙ يـجـب وضـع رابـط صحـيح **")
            addgvar(vname, vinfo)
            if BOTLOG_CHATID:
                await event.client.send_message(BOTLOG_CHATID,f"**𓅓︙ اضف فـار\n𓅓︙ {vname} الفارالذي تم تعديله :")
                await event.client.send_message(BOTLOG_CHATID, vinfo, silent=True)
            await edit_delete(event, f"**𓅓︙  📑 القيـمة لـ {vname} \n𓅓︙   تـم تغييـرها لـ :-** `{vinfo}`", time=20)
        if cmd == "جلب":
            var_data = gvarstatus(vname)
            await edit_delete(event, f"**𓅓︙  📑 قيـمة الـ {vname}** \n𓅓︙   هية  `{var_data}`", time=20)
        elif cmd == "حذف":
            delgvar(vname)
            if BOTLOG_CHATID:
                await event.client.send_message(BOTLOG_CHATID, f"**𓅓︙ حـذف فـار **\n**𓅓︙ {vname}** تـم حـذف هـذا الفـار **")
            await edit_delete(event,f"**𓅓︙  📑 قيـمة الـ {vname}** \n**𓅓︙   تم حذفها ووضع القيمه الاصلية لها**",time=20)
    else:
        await edit_delete(event, f"**𓅓︙  📑 يـجب وضع الفار الصحـيح من هذه الـقائمة :\n\n**{vnlist}",time=60)
...
async def _(event):
    ...
    if input_str == "image":
        ...
        as_text = True
    catevent = await edit_or_reply(event, "**𓅓︙   جـاري حسـاب سرعـه الانـترنيـت لـديك  🔁**")
    start = time()
    ...
    try:
        ...
        if as_text:
            await catevent.edit(                """**𓅓︙   حسـاب سرعـه الانـترنيـت لـديك  📶 : {} ثانية**
**𓅓︙   التنزيل 📶 :** `{} (or) {} ميغا بايت`
**𓅓︙   الرفع 📶 :** `{} (or) {} ميغا بايت`
**𓅓︙   البنك :** {}` بالثانية`
**𓅓︙   مزود خدمة الإنترنت 📢 :** `{}`
**𓅓︙   تقيم الانترنيت :** `{}`""".format(                    ms,                    convert_from_bytes(download_speed),                    round(download_speed / 8e6, 2),                    convert_from_bytes(upload_speed),                    round(upload_speed / 8e6, 2),                    ping_time,                    i_s_p,                    i_s_p_rating,                )            )
        else:
        ...
        await catevent.edit(            
"""**𓅓︙   حسـاب سرعـه الانـترنيـت لـديك  📶 : {} ثانية**
**𓅓︙   التنزيل 📶:** `{} (or) {} ميغا بايت`
**𓅓︙   الرفع 📶:** `{} (or) {} ميغا بايت`
**𓅓︙   البنك :** {}` بالثانية`
**𓅓︙  مع الأخطاء التالية :** {}""".format(                ms,                convert_from_bytes(download_speed),                round(download_speed / 8e6, 2),                convert_from_bytes(upload_speed),                round(upload_speed / 8e6, 2),                ping_time,                str(exc),            )        )
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqthon(iqthon):
        ...
        if query.startswith("تنصيب") and iqthon.query.user_id == bot.uid:
            buttons = [[Button.url("1- شرح التنصيب", "https://t.me/tytytytyyytt5t"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "https://replit.com/@telethon-Arab/generatestringsession#start.sh"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://github.com"),],[Button.url("المطـور 👨🏼‍💻", "https://t.me/U_7h1"),]]
...
𓅓  اوامر الكروب  ↢ ( .م3 )
𓅓  اوامر الكروب² ↢ ( .م4 )
𓅓  اوامر التحويلات ↢ ( .م5 )
𓅓  اوامر الالعاب ↢ ( .م6 )
𓅓  اوامر الميمز  ↢ ( .م7 )
𓅓  اوامر التسلية ↢ ( .م8 )
𓅓  اوامر الوقتية ↢ ( .م9 )
𓅓  اوامر الفارات ↢ ( .م10 )
𓅓  اوامر السوبرات ↢ ( .م11 )
𓅓  اوامر الاغاني ↢ ( .م12 )
𓅓  اوامر التكرار ↢ ( .م13 )
𓅓  اوامر الزخرفة ↢ ( .م14 )
𓅓  اوامر الوسائط ↢ ( .م15 )
𓅓  اوامر الملصقات ↢ ( .م16 )
———————×———————
شرح الأوامر : ( @Yosr3456 ) .
مطور السورس : ( @U_7h1 ) .
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/Yosr3456/4483
شرح الأوامر : ( @Yosr3456 ) .
قناه السورس : ( @IQTHON ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/Yosr3456/4704 
قناه السورس : ( @IQTHON ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2 
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/Yosr3456/4705
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/Yosr3456/4721  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/Yosr3456/4720  ⦒
""")
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**𓅓︙ قـائمـه الاوامـر :**\n**𓅓︙ قنـاه السـورس :** @Yosr3456\n**𓅓︙ شـرح اوامـر السـورس : @Yosr3456**\n**𓅓︙ شـرح فـارات السـورس : @Yosr3456** "
    ...
    if event.reply_to_msg_id:
        try:
            ...
            if "(" not in downloaded_file_name:
                ...
                shortname = path1.stem
                load_module(shortname.replace(".py", ""))
                await edit_delete(event, f"**𓅓︙   تم تثبيـت الملـف بنجـاح ✓** `{os.path.basename(downloaded_file_name)}`", 10)
            else:
                os.remove(downloaded_file_name)
                await edit_delete(event, "**𓅓︙  حـدث خطـأ، هـذا الملف مثبـت بالفعـل !**", 10)
        except Exception as e:
            await edit_delete(event, f"**𓅓︙  خطـأ ⚠️:**\n`{str(e)}`", 10)
            os.remove(downloaded_file_name)
...
async def unload(event):
    ...
    if not os.path.exists(path):
        return await edit_delete(event, f"**𓅓︙   ملـف مـع مسـار ⚠️ {path} لإلغـاء التثبيـت ⊠**")
    os.remove(path)
    ...
    try:
        ...
        await edit_or_reply(event, f"**𓅓︙   {shortname} تم إلغـاء التثبيـت بنجـاح ✓**")
    except Exception as e:
        await edit_or_reply(event, f"**𓅓︙  تمـت الإزالـة بنجـاح ✓ : {shortname}\n{str(e)}**")
